...
const Home = () => {
    return (
        <div id="home" className='flex justify-center animate-fadeIn mx-auto'>
            <div className=" flex flex-nowrap items-center justify-between h-[100%] w-[90%] md:w-[80%] l:w-[70%] bg-[rgba(255,255,255,0.2)] dark:bg-[rgba(63,63,63,0.51)] backdrop-blur-lg shadow-lg shadow-black/50 rounded-3xl p-10 gap-9 ">
                <div className=' animate-fadeIn delay-300 flex flex-col gap-5 md:px-5 xl:px-10'>
                    ...
                    <div className="flex items-center gap-3 dark:text-white text-sm sm:text-xl transition-all duration-300">
                ...
                <div className=' flex flex-col items-end justify-center gap-3 md:px-5 xl:px-10'>
