            ...
            <div>
                <ul className="flex items-center justify-between gap-8 mx-auto max-w-full">
                    <li className="cursor-pointer text-lg font-semibold text-gray-800 transition ease-in-out delay-75 bg-inherit hover:bg-slate500 duration300">
                        ...
                        after:content-[''] after:absolute after:bottom-0 after:right-[5%] after:w-[90%] after:h-[2px] after:bg-black
                        after:transition-all after:duration-300 after:ease-in-out
                        hover:after:w-0 hover:after:left-[5%]">Home</a>
                    </li>
                    <li className="cursor-pointer text-lg font-semibold text-gray-800 transition ease-in-out delay-75 bg-inherit hover:bg-slate500 duration300">
                        <a href="#stack" className="text-lg font-semibold text-gray-800 uppercase tracking-wide relative inline-block p-3 
                        after:content-[''] after:absolute after:bottom-0 after:right-[5%] after:w-[90%] after:h-[2px] after:bg-black
                        after:transition-all after:duration-300 after:ease-in-out
                        hover:after:w-0 hover:after:left-[5%] hover:animate-pulse">Tech Stack</a>
                    </li>
                    <li className="cursor-pointer text-lg font-semibold text-gray-800 transition ease-in-out delay-75 bg-inherit hover:bg-slate500 duration300">
                        <a href="#projects" className="text-lg font-semibold text-gray-800 uppercase tracking-wide relative inline-block p-3 
                        after:content-[''] after:absolute after:bottom-0 after:right-[5%] after:w-[90%] after:h-[2px] after:bg-black
                        after:transition-all after:duration-300 after:ease-in-out
                        hover:after:w-0 hover:after:left-[5%] hover:animate-pulse">Gallery / Edu</a>
                    </li>
                    <li className="cursor-pointer text-lg font-semibold text-gray-800 transition ease-in-out delay-75 bg-inherit hover:bg-slate500 duration300">
                        <a href="#contact" className="text-lg font-semibold text-gray-800 uppercase tracking-wide relative inline-block p-3 
                        after:content-[''] after:absolute after:bottom-0 after:right-[5%] after:w-[90%] after:h-[2px] after:bg-black
                        after:transition-all after:duration-300 after:ease-in-out
